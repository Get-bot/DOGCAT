...
<body>
	...
	<div class="offcanvas-menu-wrapper">
		...
		<div class="offcanvas__logo">
			<a href="./index.html"><img src="resources/img/멍이냥 로고2.png"
				width="150px" alt=""></a>
		</div>
			...
			<div class="inner">
				<nav class="lnb lnb_scroll v3">
					<ul>
						...
						<li><a href="vodboardlist" class="on"><span>강의
									동영상</span></a></li>
					</ul>
				</nav>
			</div>
					...
					<div class="block block-border-bottom-grey block-pd-sm"
						...
						<div class="bbs-header">
							<form id="sform" method="get"
								action="http://www.geojeyouth.com/web/vod_list"
								autocomplete="off">
								<input type="hidden" name="page" value="1"> <input
									type="hidden" name="bbs" value="vod">
								...
								<div class="bbs-search">
									...
									</select> <input type="text" name="s_que" value="" placeholder="검색어 입력">
									<button type="submit" class="bbs-button">검색</button>
								</div>
							</form>
						</div>
						<!-- 검색폼 끝 -->
					...
					<div class="block">
						<div class="row" style="min-height: 430px;">
							...
							<div class="gall_list">
								<ul>
									<c:forEach var="vodboard" items="${boardList}">
										<li><span class="select_btn"></span> <a
											href="vodboardview?bnumber=${vodboard.vodbnumber}&page=${paging.page}&btype=vod">
												<div class="gimg">{vodboard.vodcontents}</div> <span
												class="title">${vodboard.vodbtitle}</span> <span
												class="date">${vodboard.vodbdate}</span>
										</a></li>
									</c:forEach>
								</ul>
							</div>
							...
							<div class="apagination">
								...
								<c:if test="${paging.page>1}">
									<a class="btn_first" href="vodboardlist?page=${paging.page-1}">이전</a>
								</c:if>
							...
							<c:if test="${sessionScope.loginId eq 'admin'}">
								<div class="bbs-control">
									<div class="right">
										<a
											href="vodboardwritefileform?mid=${sessionScope.loginedId}&page=${paging.page}&type=vod"
											class="bbs-button">글작성하기</a>
									</div>
								</div>
							</c:if>
						</div>
