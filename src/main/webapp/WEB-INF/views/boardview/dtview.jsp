                        ...
                        <div class="bbs-document-wrap" itemscope="" itemtype="http://schema.org/Article">
	                           ...
	                           <div >
	                           	<table class="table" style="margin:5px;">
	                           		<c:forEach var="comment" items="${commentList}">
	                           			<tr>
	                           				<td style="width:8%;text-align:center;height:35px;color:#669de8;font-weight:600;"id="commentArea">
                                        	${comment.cwriter}</td>
	                           				<td class="form-control" style="width:100%;height:45px;">${comment.ccontents}</td>
	                           			</tr>
	                           		</c:forEach>
	                           	</table>
	                           </div>	 -->
                            ...
                            <div class="bbs-reply" style="margin:0;">
                                ...
                                <table class="table" style="margin:0px; margin-bottom:10px;">
                                    <tr height="75">
                                        <td style="width:8%;text-align:center;padding-top:25px;color:#669de8;font-weight:600;">
                                        ${sessionScope.loginId}</td>
                                        <td><textarea id="ccontents" class="form-control" name="contents" style="width:100%;height:55px;"></textarea></td>
                                        <td style="width:17%;padding-top:20px;">
                                        <button type="button" class="btn btn-info" id="commentWriteBtn">댓글 등록</button></td>
                                    </tr>
                                    </table>
                                </div>
                            </div>
