						...
						<div class="bbs-header">
							<form id="sform" method="get"
								...
								<input type="hidden" name="page" value="1"> <input
									type="hidden" name="bbs" value="news">
					...
					<div class="block">
						<div class="row" style="min-height: 430px;">
										...
										<c:forEach var="dtboard" items="${boardList}">
											<tr>
												...
												<td class="bbs-list-title"><a
													href="dtboardview?bnumber=${dtboard.dtbnumber}&page=${paging.page}&btype=doctor">
														<div class="bbs-cut-strings">${dtboard.dtbtitle}</div>
														<div class="bbs-mobile-contents">
															<span class="contents-item">${dtboard.dtbwriter}</span> <span
																class="contents-item">${dtboard.dtbdate}</span> <span
																class="contents-item">${dtboard.dtbhits}</span>
														</div>
												</a></td>
							...
							<div class="apagination">
								...
								<c:if test="${paging.page>1}">
									<a class="btn_first" href="dtboardlist?page=${paging.page-1}">이전</a>
								</c:if>
							...
							<div class="bbs-control">
								<c:if test="${sessionScope.loginId ne 'null'}">
									<div class="right">
										<a
											href="dtboardwritefileform?mid=${sessionScope.loginedId}&page=${paging.page}&type=doctor"
