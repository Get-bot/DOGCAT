					...
					<div class="block block-border-bottom-grey block-pd-sm"
						...
						<div class="bbs-header">
							<form id="sform" method="get"
								action="http://www.geojeyouth.com/web/bbs" autocomplete="off">
								<input type="hidden" name="page" value="1"> <input
									type="hidden" name="bbs" value="gongji">
					...
					<div class="block">
						<div class="row" style="min-height: 430px;">
									...
									<tbody>
										...
										<c:forEach var="ntboard" items="${boardList}">
											<tr>
												...
												<td class="bbs-list-title"><a
													href="ntboardview?bnumber=${ntboard.ntbnumber}&page=${paging.page}&btype=notice">
														<div class="bbs-cut-strings">${ntboard.ntbtitle}</div>
														<div class="bbs-mobile-contents">
															<span class="contents-item">${ntboard.ntbwriter}</span> <span
																class="contents-item">${ntboard.ntbdate}</span> <span
																class="contents-item">${ntboard.ntbhits}</span>
														</div>
												</a></td>
							...
							<div class="apagination">
								...
								<c:if test="${paging.page>1}">
									<a class="btn_first" href="ntboardlist?page=${paging.page-1}">이전</a>
								</c:if>
						...
						<c:if test="${sessionScope.loginId eq 'admin'}">
							<div class="bbs-control">
								<div class="right">
									<a
										href="ntboardwritefileform?mid=${sessionScope.loginedId}&page=${paging.page}&type=notice"
