					...
					<div class="block block-border-bottom-grey block-pd-sm"
						...
						<div class="bbs-header">
							<form id="sform" method="get"
								action="http://www.geojeyouth.com/web/photo_list"
								autocomplete="off">
								<input type="hidden" name="page" value="1"> <input
									type="hidden" name="bbs" value="gall">
					...
					<div class="block">
						<div class="row" style="min-height: 430px;">
								...
								<ul>
									<c:forEach var="ptboard" items="${boardList}">
										<li><span class="select_btn"></span> <a
											href="ptboardview?bnumber=${ptboard.ptbnumber}&page=${paging.page}&btype=photo">
												<div class="gimg">${ptboard.ptbcontents}</div> <span
												class="title">${ptboard.ptbtitle}</span> <span class="date">${ptboard.ptbdate}</span>
										</a></li>
									</c:forEach>
								</ul>
							</div>
							...
							<div class="apagination">
								...
								<c:if test="${paging.page>1}">
									<a class="btn_first" href="ptboardlist?page=${paging.page-1}">이전</a>
								</c:if>
							...
							<div class="bbs-control">
								<c:if test="${sessionScope.loginId ne 'null'}">
									<div class="right">
										<a
											href="ptboardwritefileform?mid=${sessionScope.loginedId}&page=${paging.page}&type=photo"
