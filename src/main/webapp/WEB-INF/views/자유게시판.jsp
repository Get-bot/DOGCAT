						...
						<div class="bbs-header">
							<form id="sform" method="get"
								...
								<input type="hidden" name="page" value="1"> <input
									type="hidden" name="bbs" value="free">
					...
					<div class="block">
						<div class="row" style="min-height: 430px;">
										...
										<c:forEach var="freeboard" items="${boardList}">
											<tr>
												...
												<td class="bbs-list-title"><a
													href="freeboardview?bnumber=${freeboard.freebnumber}&page=${paging.page}&btype=free">
														<div class="bbs-cut-strings">
															${freeboard.freebtitle}</div>
							...
							<div class="apagination">
								...
								<c:if test="${paging.page>1}">
									<a class="btn_first" href="freeboardlist?page=${paging.page-1}">이전</a>
								</c:if>
							...
							<div class="bbs-control">
								<c:if test="${sessionScope.loginId eq 'admin'}">
									<div class="right">
										<a
											href="freeboardwritefileform?&page=${paging.page}&type=free"
