...
public class DTBoardService {
	...
	public ModelAndView boardView(int bnumber, int page ,String btype) {
		mav = new ModelAndView();
		boardDAO.boardHits(bnumber);
		DTBoardDTO boardView = boardDAO.boardView(bnumber);
		
		String bnum= Integer.toString(bnumber);
		List<CommentDTO> commentList = commentDAO.commentList(bnum,btype);
